...
<section class="py-5">
    ...
    <div class="d-flex justify-content mt-3 mb-3">
        <div class="row">
            ...
            <h3>Exibirr Registros em um campo SELECT</h3>

                <div class="form-floating mt-3 mb-3"></div>

                    <select class="form-select" name="nomeUsuario">
                        <?php 
                        include "conexaoBD.php";
                        $listarUsuarios = "SELECT * FROM Usuarios";
                        $res = mysqli_query($conn, $listarUsuarios) or die ("Erro ao carregar usuario");
                    ...
                    <label for="nomeUsuario">Selecione um Usuario</label>
            </div>
        </div>
    </div>
</section>
